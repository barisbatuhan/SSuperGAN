...
from training.ssuper_global_stylegan2_trainer import SSuperGlobalStyleGAN2Trainer
from utils.config_utils import read_config, Config
from utils.logging_utils import *
from utils.plot_utils import *
from configs.base_config import *

def train(tr_data_loader, val_data_loader, config, model_name='ssuper_global_stylegan2', cont_model=None):
    
    print("\n[INFO] Initiating training...")
    
    net = SSuperGlobalStyleGAN2(
    ...
    # init trainer
    trainer = SSuperGlobalStyleGAN2Trainer(
        model=net,
        model_name=model_name,
        criterion={
            "loss_type": "basic",
            "gen_global_ratio": 0.01,
            "recon_ratio": 1,
        },
